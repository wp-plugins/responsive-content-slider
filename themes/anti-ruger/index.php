...
function rcs_body_anti_ruger($post_id)
	{
		...
		$rcs_body.= '
			<div class="rcs-items" >
				...
				<div style="max-height:'.$rcs_items_thumb_max_hieght.';" class="rcs-items-thumb"><a href="'.get_permalink().'"><img src="'.$rcs_thumb_url.'" /></a></div>
